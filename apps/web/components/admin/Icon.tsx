// Admin icon set (lucide-style, stroke 1.6, currentColor). Ported from the
// design handoff so the console needs no icon dependency.
...
const ICON_PATHS: Record<string, string> = {
  ...
  checkAll: '<path d="m2 12 5 5 5-5M9 12l5 5 8-8"/>',
};
